...
class GetExtraMFResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoMfForArrayConstraintFromSetMidocoMf(?array $values = []): string
    {
        ...
        foreach ($values as $getExtraMFResponseMidocoMfItem) {
            ...
            if (!$getExtraMFResponseMidocoMfItem instanceof \Pggns\MidocoApi\WorkflowSD\StructType\MidocoMf) {
     ...
     * @param \Pggns\MidocoApi\WorkflowSD\StructType\MidocoMf[] $midocoMf
     * @return \Pggns\MidocoApi\WorkflowSD\StructType\GetExtraMFResponse
     */
